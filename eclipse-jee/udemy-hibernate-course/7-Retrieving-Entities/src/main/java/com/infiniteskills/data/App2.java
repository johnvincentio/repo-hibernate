...
java.lang.NullPointerException
	at com.infiniteskills.data.App2.main(App2.java:24)
*/
public class App2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Bank bank = (Bank) session.get(Bank.class, 123L);		// does not exist
			System.out.println("Method Executed");
			
			System.out.println(bank.getName());		// null pointer
			transaction.commit();
		}
		catch (Exception e) {
			e.printStackTrace();
