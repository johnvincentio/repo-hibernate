...
/*
 * Temporal annotation allows for the column to handle the specific date type.
 * java.util.date is abstract, does not specify date type.
 * 
 * Use @Temporal for Date or Calendar.
 */
@Entity
