 ...
 * 
 * table user_account allows finances_user to have many accounts and
 * for accounts to have many finances_users.
...
Hibernate: insert into USER_ACCOUNT (ACCOUNT_ID, USER_ID) values (?, ?)
Hibernate: insert into USER_ADDRESS (USER_ID, USER_ADDRESS_LINE_1, USER_ADDRESS_LINE_2, ADDRESS_TYPE, CITY, STATE, ZIP_CODE) values (?, ?, ?, ?, ?, ?, ?)
Hibernate: insert into USER_ADDRESS (USER_ID, USER_ADDRESS_LINE_1, USER_ADDRESS_LINE_2, ADDRESS_TYPE, CITY, STATE, ZIP_CODE) values (?, ?, ?, ?, ?, ?, ?)
Hibernate: insert into USER_ACCOUNT (ACCOUNT_ID, USER_ID) values (?, ?)
Hibernate: insert into USER_ACCOUNT (ACCOUNT_ID, USER_ID) values (?, ?)
test@test.com
...
public class Application {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(dbAccount.getUsers().iterator().next().getEmailAddress());	// as is a Set
		}
		catch (Exception e) {
			e.printStackTrace();
		}
